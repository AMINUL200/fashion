...
const HandleProductCategory = () => {
  ...
  // Color Schema - Simple white background with dark navy blue buttons
  const colors = {
    primary: "#1B2B4C", // Dark Navy Blue
    primaryHover: "#FFFFFF", // White on hover
    background: "#FFFFFF", // White background
    cardBg: "#F8F9FA", // Light gray for cards
    border: "#E2E8F0", // Light gray border
    text: "#1E293B", // Dark slate for text
    textLight: "#64748B", // Light slate for secondary text
  ...
  const handleEdit = (category) => {
    ...
    setFormData({
      name: category.name || "",
      name_meta: category.name_meta || "",
      image: category.image || null,
      image_alt: category.image_alt || "",
      status: category.status === 1 || category.status === true || category.status === "1" ? true : false,
    });
    setShowModal(true);
  };
  ...
  const filteredCategories = categories.filter(
    (category) =>
      ...
      category.name_meta?.toLowerCase().includes(searchTerm.toLowerCase()),
  );
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        {/* Add Button - Dark Navy Blue with White Hover */}
        <button
          onClick={handleAdd}
                    ...
                    <td className="px-6 py-4">
                      {category.name_meta ? (
                        <span
                          ...
                          style={{ color: colors.textLight }}
                        >
                          {category.name_meta.length > 30
                            ? category.name_meta.substring(0, 30) + "..."
                            : category.name_meta}
                        </span>
                      ) : (
                      ...
                      {category.image_alt && (
                        ...
                        >
                          Alt:{" "}
                          {category.image_alt.length > 20
                            ? category.image_alt.substring(0, 20) + "..."
                            : category.image_alt}
                        </div>
                      )}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-semibold transition-all ${
                          category.status === 1 || category.status === true || category.status === "1"
          ...
          >
            ...
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              ...
              <div className="mb-4">
                ...
                {editingCategory && editingCategory.image && !imagePreview && (
                  <div
              ...
              <div className="mb-6">
                ...
                <p className="text-xs mt-1" style={{ color: colors.textLight }}>
                  Enable to make this category visible to users
                </p>
              </div>
