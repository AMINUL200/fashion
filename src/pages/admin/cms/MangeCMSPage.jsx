...
const MangeCMSPage = () => {
  ...
  const handleEdit = (page) => {
    ...
    setFormData({
      ...
      status: page.status === 1 || page.status === true || page.status === "1" ? true : false,
    });
    if (page.image) {
                    ...
                    <td className="px-6 py-4">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-semibold transition-all ${
                          page.status === 1 || page.status === true || page.status === "1"
                            ? "bg-green-100 text-green-700 hover:bg-green-200"
                            : "bg-red-100 text-red-700 hover:bg-red-200"
                        }`}
                      >
                        {page.status === 1 || page.status === true || page.status === "1" ? "Active" : "Inactive"}
                      </button>
                     </td>
                    <td className="px-6 py-4">
